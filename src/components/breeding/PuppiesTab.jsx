        ...
        <Card className="bg-white text-black">
          <CardHeader>
            <div className="flex justify-between items-center">
              <div>
                <CardTitle className="text-black flex items-center gap-2"><Dog />Our Dogs</CardTitle>
                <CardDescription className="text-gray-500">
                  Total Paid: <span className="font-bold text-black">${formatNumber(totalInvestment.paid)}</span> | 
                  Total Value (Kept): <span className="font-bold text-black">${formatNumber(totalInvestment.valued)}</span>
                </CardDescription>
              </div>
