...
export const PaymentForm = ({ puppies, onSave, onCancel }) => {
    const [formData, setFormData] = useState({ amount: '', payment_type: '', notes: '', puppy_id: '', payment_date: new Date().toISOString().split('T')[0] });
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4 text-black">
            ...
            <div className="space-y-2"><Label htmlFor="payment_type">Payment Type *</Label><Input id="payment_type" value={formData.payment_type} onChange={e => setFormData({...formData, payment_type: e.target.value})} required placeholder="e.g., Deposit, Final Payment" /></div>
